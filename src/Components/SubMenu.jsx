...
export default function SubMenu(props) {
  ...
  return (
    visible && (
      ...
      </div><div className="border-l-[20px] border-l-transparent border-r-transparent border-b-pure-greys-5 border-r-[20px] border-b-[30px] absolute -top-[22px] left-[100px]"></div></>
    )
  );
}
